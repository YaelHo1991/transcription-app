...
<head>
    ...
    <style>
        * {
        ...
        /* Large screen wrapper to prevent stretching */
        ...
        .crm-pricing h4, .transcription-pricing h4 {
            margin-bottom: 15px;
            font-size: 1.3em;
            font-weight: 700;
        }
            ...
            <form id="purchase-form">
                ...
                <div class="user-details-section crm-themed">
                    ...
                    <div class="user-form-grid">
                        ...
                        <div class="form-group">
                            <label for="personal-company">שם חברה (אופציונלי)</label>
                            <input type="text" id="personal-company" name="personalCompany" placeholder="שם החברה שלך">
                        </div>
                    </div>
                </div>
